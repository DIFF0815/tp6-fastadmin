...
class FaAdminMenuRule extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('fa_admin_menu_rule', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_unicode_ci', 'comment' => '节点表' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
